 ...
 * @endcode
 */
# $settings['hash_salt'] = 'PjteRKqC_AwGysOKV1ivyUCeilY3bXEDC8Kh6zRRRBEBDp3Y5Vz_B8Ze1pv9WV4z01Kx96EC9Q';
...
if (getenv('OPENID_CONNECT_CLIENT_ID')) {
  $config['openid_connect.settings.generic']['settings']['client_id'] = getenv('OPENID_CONNECT_CLIENT_ID');
}

if (getenv('OPENID_CONNECT_CLIENT_SECRET')) {
  $config['openid_connect.settings.generic']['settings']['client_secret'] = getenv('OPENID_CONNECT_CLIENT_SECRET');
}
